...
DST_DIR = '../../../../database/trainPosters/train.90C.1kP/JPEGImages/'
LABELS_DIR = '../../../../database/trainPosters/train.90C.1kP/labels/'
NOTE_DIR = '../../../../database/trainPosters/train.90C.1kP/'
